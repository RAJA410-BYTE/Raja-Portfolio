...
const FloatingIcon = ({ icon: Icon, delay, x, y }: { icon: React.ElementType; delay: number; x: string; y: string }) => (
  <motion.div
    ...
    animate={{ opacity: 0.6, scale: 1, y: [0, -15, 0] }}
    transition={{ 
      opacity: { delay, duration: 0.5 },
      scale: { delay, duration: 0.5 },
      y: { delay: delay + 0.5, duration: 3, repeat: Infinity, ease: "easeInOut" }
    }}
    className="absolute hidden lg:flex items-center justify-center w-12 h-12 rounded-xl bg-card/50 backdrop-blur-sm border border-border/30 text-primary/70"
    style={{ left: x, top: y }}
  >
    <Icon size={24} />
  </motion.div>
...
const HeroSection = () => {
  ...
  const socialLinks = [
    { icon: Github, href: "https://github.com/RAJA410-BYTE", label: "GitHub" },
    { icon: Linkedin, href: "https://linkedin.com/in/rajaprasad-cse", label: "LinkedIn" },
    { icon: Mail, href: "mailto:rajaprasad456712@gmail.com", label: "Email" },
  ];
      ...
      <div className="container-custom relative z-10 py-20">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              Building responsive web applications with a strong foundation in full-stack development. 
              Passionate about API testing, QA practices, and solving real-world problems through code.
            </motion.p>
            ...
            >
              {socialLinks.map((link, index) => (
                <motion.a
                  ...
                  className="w-11 h-11 rounded-xl glass flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary/50 transition-all duration-300 hover:scale-110"
                  whileHover={{ y: -3 }}
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                className="absolute inset-0 w-72 h-72 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full"
                style={{
              ...
              <motion.div
                ...
                className="absolute inset-2 w-[calc(100%-16px)] h-[calc(100%-16px)] rounded-full opacity-50"
                style={{
